...
#	execute_process(COMMAND ${CMAKE_COMMAND} -DCACHEFILE=${CACHEFILE} -DSKIPUPDATECACHE="1" -DVAROUT=1 -P "/home/lucas/warzone2100/build_tools/autorevision.cmake"
...
#	)
	...
	set(CACHEFILE "/home/lucas/warzone2100/src/build_tools/autorevision.cache")
	...
	execute_process(COMMAND ${CMAKE_COMMAND} -DCACHEFILE=${CACHEFILE} -DSKIPUPDATECACHE="1" -DCACHEFORCE="1" -DVAROUT=1 -P "/home/lucas/warzone2100/build_tools/autorevision.cmake"
	WORKING_DIRECTORY "/home/lucas/warzone2100"
	OUTPUT_VARIABLE autorevision_info
	OUTPUT_STRIP_TRAILING_WHITESPACE
)
...
include("/home/lucas/warzone2100/build_tools/autorevision_helpers.cmake")
...
if(CPACK_GENERATOR MATCHES "NSIS")
	...
	configure_file(
		/home/lucas/warzone2100/pkg/nsis/NSIS.version.in
		/home/lucas/warzone2100/src/NSIS.version.nsh
	)
